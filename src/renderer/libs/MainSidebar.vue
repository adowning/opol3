    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <router-link tag="li" to="/">
          <a><i class="fa fa-dashboard"/> <span>桌面</span></a>
        </router-link>
        <router-link tag="li" to="/landingpage">
          <a><i class="fa fa-link"/> <span>Landing Page</span></a>
        </router-link>
        <li class="treeview">
          <a href="#">
            <i class="fa fa-link"/> <span>多级</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"/>
            </span>
          </a>
          <ul class="treeview-menu">
            <router-link tag="li" to="/link21"><a>链接21</a></router-link>
            <router-link tag="li" to="/link22"><a>链接22</a></router-link>
          </ul>
        </li>
      </ul>
